...
import static roy.application.master.oksocket.IOAction.ACTION_PULSE_REQUEST;
import static roy.application.master.oksocket.IOAction.ACTION_READ_COMPLETE;
import static roy.application.master.oksocket.IOAction.ACTION_WRITE_COMPLETE;
import static roy.application.master.oksocket.IAction.ACTION_CONNECTION_FAILED;
import static roy.application.master.oksocket.IAction.ACTION_CONNECTION_SUCCESS;
import static roy.application.master.oksocket.IAction.ACTION_DISCONNECTION;
import static roy.application.master.oksocket.IAction.ACTION_READ_THREAD_SHUTDOWN;
import static roy.application.master.oksocket.IAction.ACTION_READ_THREAD_START;
import static roy.application.master.oksocket.IAction.ACTION_WRITE_THREAD_SHUTDOWN;
import static roy.application.master.oksocket.IAction.ACTION_WRITE_THREAD_START;
...
public class ActionDispatcher implements IRegister<ISocketActionListener,IConnectionManager>,IStateSender{
    ...
    public void sendBroadcast(String action, Serializable serializable) {
        ...
        if (token != null) {
            ...
            KLog.e("ActionDispatcher error action:" + action + " is not dispatch");
        }
    }
